...
# pip install -U "torch>=2.1" torchvision torchaudio
# -----------------------------
...
class LightweightTransformer(nn.Module):
    def __init__(self, input_dim, model_dim=128, nhead=4, num_layers=1, dim_feedforward=128, dropout=0.2):
        ...
        self.matching_score_layer = nn.Linear(64, 1)
    ...
    def forward(self, x):
        ...
        matching_score = torch.sigmoid(self.matching_score_layer(hidden))  # Continuous score (0-1)
        predicted_label = (matching_score > 0.5).float()                  # Final classification
