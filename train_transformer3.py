...
# -------------------------------------------------------
# Load BGE-base Model (Better than SBERT)
# -------------------------------------------------------
print("⚡ Generating BGE-base embeddings on MPS if available...")
bge_model = SentenceTransformer("BAAI/bge-base-en-v1.5", device="cpu")  # encode on CPU to avoid MPS crashes
